...
// DETEKSI APAKAH SEDANG BERJALAN ONLINE DI VERCEL ATAU LAPTOP LOKAL
$isVercel = isset($_ENV['VERCEL_JOB_ID']) || isset($_SERVER['VERCEL_URL']);

if ($isVercel) {
    
    // =========================================================================
    // JALUR ONLINE VERCEL (Mengunci Data Katalog Utama Pilihanmu 100% Aman)
    // =========================================================================
    Route::get('/', function() {
        $products = [
            (object)['name' => 'Nasi Kotak Ayam Bakar', 'category_name' => 'Makanan Berat', 'description' => 'Nasi kotak lengkap dengan Ayam Bakar bumbu madu, tahu, tempe, lalapan, dan sambal terasi.', 'price' => 25000, 'image' => 'https://unsplash.com'],
            (object)['name' => 'Paket Prasmanan Mewah', 'category_name' => 'Makanan Berat', 'description' => 'Paket makanan prasmanan untuk acara pernikahan/pesta termasuk nasi, olahan daging sapi, sup, dan pelengkap.', 'price' => 45000, 'image' => 'https://unsplash.com'],
            (object)['name' => 'Nasi Goreng Gila', 'category_name' => 'Makanan Berat', 'description' => 'Nasi goreng bumbu kencur pedas dengan topping melimpah bakso, sosis, telur ayam, dan kerupuk renyah.', 'price' => 20000, 'image' => 'https://unsplash.com'],
            (object)['name' => 'Es Teh Manis Jumbo', 'category_name' => 'Minuman Segar', 'description' => 'Es teh manis segar berukuran besar, cocok untuk menemani hidangan katering.', 'price' => 5000, 'image' => 'https://unsplash.com'],
            (object)['name' => 'Es Jeruk Peras', 'category_name' => 'Minuman Segar', 'description' => 'Minuman es jeruk murni perasan asli buah segar, kaya vitamin C, manis dan menghilangkan dahaga.', 'price' => 7000, 'image' => '/images/jeruk.jpg']
        ];
        ...
        $html .= '</div></div><footer><p>&copy; 2026 DandiCatering.</p></footer></body></html>';
    ...
    // =========================================================================
    // JALUR LAPTOP LOKAL (Dialihkan ke Controller agar file Route ini sangat pendek)
    // =========================================================================
    
    // Membuka Halaman Utama Depan Toko (Membaca data database 'Baru' kamu)
    Route::get('/', [ProductController::class, 'index']);

    // Mengaktifkan Fitur Admin, Pengolahan Tambah & Hapus Menu
